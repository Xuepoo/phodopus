...
- **Pure-Rust implementation**: Zero C dependencies, suitable for embedded and isolated environments. `unsafe` is confined to specific VM and `gc-arena` primitives; see the security ledger.
