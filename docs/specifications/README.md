...
| [Module Resolver Specification](module-resolver.md) | Specification | Accepted | Planned (Phase 2) | Sandboxed module resolution (`require`), searcher chains, and virtual filesystem providers. |
