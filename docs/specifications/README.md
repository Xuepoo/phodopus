...
| :---------------------------------------------------------- | :------------ | :------- | :--------------------- | :------------------------------------------------------------------------------------------------ |
| [Sandbox & Fuel Specification](sandbox-and-fuel.md)         | Specification | Accepted | Partial (Fuel + quota) | Deterministic instruction budgeting, preemption thresholds, and hard heap allocation ceilings.    |
